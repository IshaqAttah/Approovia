...
func TestRootEndpoint(t *testing.T) {
	...
	body := rr.Body.String()
	if !strings.Contains(body, "Hello from Service A") {
...
func TestResponseFormat(t *testing.T) {
	...
	// Should start with "Hello from Service A"
	if !strings.HasPrefix(body, "Hello from Service A") {
		t.Errorf("Response should start with 'Hello from Service A', got: %v", body)
	}
}
